...
UI_TEXT = {
    "ko": {
        ...
        "play_mode_nearby":    "📍 내 근처 사적",
        "nearby_btn":          "📍 위치 받아 가장 가까운 사적 문제",
        "nearby_distance":     "현 위치에서 약 {km}km",
        "nearby_too_far":      "어어… 현 위치 30km 안에 사료가 없소이다. 자유 테마로 가시구려.",
        "nearby_no_perm":      "위치 권한이 필요하옵니다. 브라우저 알림을 허락해 주시오.",
        "nearby_hint":         "💡 모바일에서 사용 시 브라우저 위치 권한을 허락하면, 현재 있는 곳에서 가장 가까운 사적 문제를 자동으로 받습니다.",
        "course_label":        "코스 고르기",
    ...
    "en": {
        ...
        "tour_info":          "🧭 KTO Visit Korea",
        "audio_guide":        "🎧 Audio guide",
        "kakao_map":          "🗺 KakaoMap",
        "kakao_roadview":     "🛣 Street view",
        ...
        "play_mode_nearby":    "📍 Sites near me",
        "nearby_btn":          "📍 Use my location, give me the nearest site",
        "nearby_distance":     "About {km} km from you",
        "nearby_too_far":      "No site within 30 km of your location. Try a free theme instead.",
        "nearby_no_perm":      "Location permission needed. Please allow it in your browser.",
        "nearby_hint":         "💡 On mobile, allow location permission and the Sagwan will quiz you on the nearest historical site.",
    ...
    "ja": {
        ...
        "play_mode_nearby":    "📍 近くの史跡",
        "nearby_btn":          "📍 位置情報で一番近い史跡を出題",
        "nearby_distance":     "現在地から約 {km} km",
        "nearby_too_far":      "30km以内に史料がござりませぬ。自由テーマでどうぞ。",
        "nearby_no_perm":      "位置情報の許可が必要にござります。",
        "nearby_hint":         "💡 モバイルで位置情報を許可すると、現在地から最も近い史跡を史官が出題します。",
        "course_label":        "コースを選ぶ",
    ...
    "zh": {
        ...
        "play_mode_nearby":    "📍 我附近的史迹",
        "nearby_btn":          "📍 用我的位置出最近的史迹题",
        "nearby_distance":     "距您约 {km} km",
        "nearby_too_far":      "您30公里内没有史料。请改用自由主题。",
        "nearby_no_perm":      "需要位置权限,请在浏览器中允许。",
        "nearby_hint":         "💡 在手机上允许位置权限,史官就会出最近的史迹题。",
        "course_label":        "选择路线",
